...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.5-alpine3.19 docker.io/zabbix/zabbix-server-pgsql:7.0.2-alpine docker.io/zabbix/zabbix-agent2:7.0.2-alpine docker.io/zabbix/zabbix-web-nginx-pgsql:7.0.2-alpine" \
    "${container}"
# Commit the image
