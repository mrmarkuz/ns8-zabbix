...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.12-alpine docker.io/zabbix/zabbix-server-pgsql:7.0.8-alpine docker.io/zabbix/zabbix-agent2:7.0.8-alpine docker.io/zabbix/zabbix-web-nginx-pgsql:7.0.8-alpine" \
    "${container}"
# Commit the image
