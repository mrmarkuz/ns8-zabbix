...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.14-alpine docker.io/zabbix/zabbix-server-pgsql:7.0.16-alpine docker.io/zabbix/zabbix-agent2:7.0.16-alpine docker.io/zabbix/zabbix-web-nginx-pgsql:7.0.16-alpine" \
    "${container}"
# Commit the image
