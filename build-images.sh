...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.18-alpine docker.io/zabbix/zabbix-server-pgsql:7.0.28-alpine docker.io/zabbix/zabbix-agent2:7.0.28-alpine docker.io/zabbix/zabbix-web-nginx-pgsql:7.4.13-alpine" \
    "${container}"
# Commit the image
